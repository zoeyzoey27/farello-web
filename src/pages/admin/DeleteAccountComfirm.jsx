...
import DeleteAccountConfirmed from '../../components/admin/DeleteAccountConfirmed'
import { AiOutlineToTop } from 'react-icons/ai'

const DeleteAccountComfirm = () => {
  ...
  return (
    <Spin spinning={loading} size="large">
      ...
      <Layout className="m-10">
        <DeleteAccountConfirmed setLoading={setLoading} />
      </Layout>
      </Layout>
      <BackTop>
...
export default DeleteAccountComfirm